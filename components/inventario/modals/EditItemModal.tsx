      ...
      case 'boolean':
        return (
          <div className="flex items-center space-x-3 h-12 sm:h-auto" key={attr.name}>
            ...
            />
            <Label htmlFor={`edit-attr-${attr.name}`} className="text-violet-900 cursor-pointer text-base sm:text-sm font-medium">
  ...
  return (
    ...
    >
      <div className="space-y-6 pb-8 px-1">
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2.5">
              <Label htmlFor="edit-item-name" className="text-violet-900 text-sm font-semibold">
            ...
            <div className="space-y-2.5">
              <Label htmlFor="edit-item-sku" className="text-violet-900 text-sm font-semibold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2.5">
              <Label className="text-violet-900 text-sm font-semibold">Estado general</Label>
              <Select value={status} onValueChange={(val: InventoryItemStatus) => setStatus(val)}>
                <SelectTrigger className="h-12 sm:h-10 border-violet-200 rounded-xl text-base sm:text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="available" className="h-11 text-base sm:text-sm">Disponible</SelectItem>
                  <SelectItem value="maintenance" className="h-11 text-base sm:text-sm">Mantenimiento</SelectItem>
                  <SelectItem value="retired" className="h-11 text-base sm:text-sm">Retirado</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        <div className="space-y-5">
          <h4 className="text-sm font-bold text-violet-950 border-b border-violet-100 pb-2">Precios y Ubicación</h4>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-2.5">
              <Label className="text-violet-900 text-sm font-semibold">Precio Renta ($)</Label>
              <Input
                type="number"
                value={rentPrice}
            ...
            <div className="space-y-2.5">
              <Label className="text-violet-900 text-sm font-semibold">Precio Venta ($)</Label>
              <Input
                type="number"
                value={salePrice}
            ...
            <div className="space-y-2.5">
              <Label className="text-violet-900 text-sm font-semibold">Ubicación Actual</Label>
