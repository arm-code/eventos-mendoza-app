...
export function AppBottomSheet({
  ...
  // Cabecera móvil con la estética nativa de iOS
    ...
    <div className="sticky top-0 z-10 shrink-0 border-b bg-background/95 px-4 pb-3 pt-3 backdrop-blur-md">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Button
          ...
          className="size-11 shrink-0 rounded-full text-muted-foreground hover:bg-accent hover:text-accent-foreground"
          aria-label="Cerrar"
        >
